...
d3.json("data/asniffer-sview.json").then(data => {
    ...
    //const color = d3.scaleOrdinal(d3.schemeSpectral[16]);
    const color = d3.scaleOrdinal(d3.schemeAccent);

    //console.log(color);
    //console.log(schemaSet.size);
    let schemaMapArray = [];
    ...
    // // column definitions
    // const columns = [
    //   { head: "Annotation Schema", cl: "schema", html: function(row) { return r.schema;} },
    //   { head: "Color", cl: "color", html: function(row) { return r.color;} },
    // ];
    ...
    //schema_table.select("tbody").selectAll("tr").data(schemaSet).enter().append("tr").append("td").text(d=>d);
