...
export class SVGUtils{
    ...
    public static createPopUp(d: any, svg: any, event: any){
		...
		const divTooltip = d3.select("body").append("div")
			...
			.style("background","#BCC5F7")
			.html("Package Name: "+d.parent.parent.data.name+"<br/>"+d.parent.data.type+" Name "+classname[classname.length-1]+"<br/>"+"Annotation name: "+d.data.name+"<br/>"+"LOCAD: "+d.data.value)
		        .transition()
        		.duration(200);
		...
		const divTooltip = d3.select("body").append("div")
        		...
        		.style("top", (event.pageY - 60) + "px")
			.style("background","#BCC5F7")
			.html("Package Name: "+d.parent.parent.parent.data.name+"<br/>"+"Class Name: "+classname[classname.length-1]+"<br/>"+d.parent.data.type+" Name "+componentname[componentname.length-1]+"<br/>"+"Annotation name: "+d.data.name+"<br/>"+"LOCAD: "+d.data.properties.locad)
		        .transition()
        		.duration(200);
